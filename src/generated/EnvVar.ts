...
export class EnvVar extends RestObject {
    ...
    constructor(fields?: EnvVarFields, client?: Rest) {
    ...
    public static async retrieve(qryParam: ((fields: FieldResolver<EnvVar>) => SOQLQueryParams) | string): Promise<EnvVar[]> {

        let qry = typeof qryParam === 'function' ? buildQuery(EnvVar, qryParam) : qryParam;
        return await RestObject.query<EnvVar>(EnvVar, qry);
