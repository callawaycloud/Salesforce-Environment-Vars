...
**via sfdx-cli**
`sfdx force:package:install --package 04t1C000000ODWeQAO -u your@org.user`

**via url**
login and navigate to [`/packaging/installPackage.apexp?p0=04t1C000000ODWeQAO`](https://login.salesforce.com/packaging/installPackage.apexp?p0=04t1C000000ODWeQAO). Choose `Install for: Admin Only`.
